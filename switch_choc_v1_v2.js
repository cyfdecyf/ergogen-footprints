...
module.exports = {
  ...
  (footprint "ceoloide:switch_choc_v1_v2"
	...
	(segment
		(start ${p.eaxy(-1.704, -1.896)})
		(end ${p.eaxy(-0.975, -2.625)})
		(width ${p.trace_width})
    (locked ${p.locked_traces_vias ? 'yes' : 'no'})
		(layer "F.Cu")
		(net ${p.to.index})
